...
if HAS_TAGGING:
    from seahub_extra.tagging.views import personal_tags, personal_tag_detail, \
        group_tags, group_tag_detail
    urlpatterns += patterns('',
        (r'^tags/', include('seahub_extra.tagging.urls')),
        url(r'^home/tags/$', personal_tags, name='personal_tags'),
        url(r'^home/tags/(?P<tag>[^/]{1,})/$', personal_tag_detail, name='personal_tag_detail'),
        url(r'^group/(?P<group_id>\d+)/tags/$', group_tags, name='group_tags'),
        url(r'^group/(?P<group_id>\d+)/tags/(?P<tag>[^/]{1,})/$', group_tag_detail, name='group_tag_detail'),
    )